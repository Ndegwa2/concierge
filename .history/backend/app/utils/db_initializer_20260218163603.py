...
def initialize_database():
    ...
    if Service.query.count() == 0:
        ...
        user1 = User()
        user1.name = 'Obi Okafor'
        user1.email = 'obi@example.com'
        user1.set_password('password123')
        user1.phone = '+254712345678'
        user1.address = '123 Kenyatta Ave, Nairobi'
        users.append(user1)
        
        user2 = User()
        user2.name = 'Amara Diallo'
        user2.email = 'amara@example.com'
        user2.set_password('password123')
        user2.phone = '+254723456789'
        user2.address = '456 Moi Ave, Nairobi'
        users.append(user2)
        
        user3 = User()
        user3.name = 'Kofi Mensah'
        user3.email = 'kofi@example.com'
        user3.set_password('password123')
        user3.phone = '+254734567890'
        user3.address = '789 Uhuru Hwy, Nairobi'
        users.append(user3)
