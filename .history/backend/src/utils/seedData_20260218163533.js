  ...
  try {
    ...
    await ServicePartner.createMany([
      ...
      },
      {
        ...
        contact: {
          name: 'Ngozi Adeyemi',
          email: 'ngozi@premiumcarwash.com',
          phone: '+254756789012'
        },
        address: {
    ...
    console.log('Employee login:', { email: 'obi@autoconcierge.com', password: 'employee123' });
    console.log('Customer login:', { email: 'amara@example.com', password: 'customer123' });
