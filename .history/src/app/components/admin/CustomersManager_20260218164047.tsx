...
export function CustomersManager() {
  ...
  const customers = [
    ...
    },
    {
      id: 'CU-1003',
      name: 'Obi Okafor',
      email: 'obi.okafor@example.com',
      phone: '+254 734-0103',
      vehicles: ['Mercedes E-Class (2021)', 'Porsche 911 (2023)'],
      totalServices: 32,
      totalSpent: 'KES 329,000',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-2xl font-bold">KES 1,022,000</div>
